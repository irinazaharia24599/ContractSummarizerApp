...
# contractant -> no numeContractant "," _ text _ calitate _ml {% (data) => data[1] %}

 contractant -> no numeContractant "," _ cetatenie "," _ adresa "," _ carteIdentitate "," _ cnp "," _ calitate ",":? _ml {% (data) => data[1] %}
# contractant -> no numeContractant "," _ cetatenie ","  _ carteIdentitate "," _ cnp "," _ calitate ",":? _ml {% (data) => data[1] %}
