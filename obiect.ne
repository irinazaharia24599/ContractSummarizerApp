...
#                 | (obiectContractSchimb obiectContractSchimb) {% (data) => data[0]  + "; " + data[1] %}
...
# obiectContractSchimb -> no "Copermutantul " ("prim" | "secund") " dă în deplină proprietate copermutantului " ("prim" | "secund") " dreptul asupra "  obiect
